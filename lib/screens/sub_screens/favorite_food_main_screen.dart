...
class FavoriteFoodMainScreen extends StatefulWidget {
  const FavoriteFoodMainScreen({super.key});

  @override
  State<FavoriteFoodMainScreen> createState() => _FavoriteFoodMainScreenState();
}

class _FavoriteFoodMainScreenState extends State<FavoriteFoodMainScreen> {
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          final currentDisplayedItems = items.where((item) {
                            ...
                            return favoriteFoodIds.contains(item.place_id)
                                && rating >= 4.0
                                && userRatingsTotal > 30;
                          }).toList();
